...
def main():
    ...
    for j, (train_idx, val_idx) in enumerate(folds):
        ...
        train_y_data = [train_y_files[train_idx[i] % len(train_y_files)] for i in range(len(train_idx))]
        val_x_data = [train_x_files[val_idx[i]] for i in range(len(val_idx))]
        val_y_data = [train_y_files[val_idx[i] % len(train_y_files)] for i in range(len(val_idx))]
