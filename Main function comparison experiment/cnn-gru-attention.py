...
def build_model_with_cnn_gru_attention(lstm_units=512, cnn_filters=512, learning_rate=0.0001):
    ...
    gru_layer = GRU(lstm_units, activation='tanh', return_sequences=True)(batch_norm_cnn)
...
def main():
    ...
    for j, (train_idx, val_idx) in enumerate(folds):
        ...
        model = build_model_with_cnn_gru_attention(lstm_units=512, cnn_filters=512, learning_rate=0.0001)
        ...
        save_predictions_and_true_values(inv_testPredict_mpc, inv_testY, 'cnn_gru_attention_predictions.csv')
