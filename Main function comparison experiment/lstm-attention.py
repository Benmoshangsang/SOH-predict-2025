...
def build_model(lstm_units=512, cnn_filters=512, learning_rate=0.0001, alpha=0.5):
    ...
    input_LSTM = Input(shape=(pr.seq_len_lstm, 10), name="LSTM_Input")
...
def main():
    ...
    for j, (train_idx, val_idx) in enumerate(folds):
        ...
        save_predictions_and_true_values(inv_testPredict_mpc, inv_testY, 'lstm_attention_predictions.csv')
