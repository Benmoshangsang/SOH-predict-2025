...
def build_model_with_cnn_lstm(cnn_filters=512, lstm_units=512, learning_rate=0.0001):
    ...
    # LSTM layer
    lstm_layer = LSTM(lstm_units, activation='tanh')(batch_norm_cnn)

    flat = Flatten()(lstm_layer)
...
def main():
    ...
    for j, (train_idx, val_idx) in enumerate(folds):
        ...
        # Create model
        model = build_model_with_cnn_lstm(cnn_filters=512, lstm_units=512, learning_rate=0.0001)
